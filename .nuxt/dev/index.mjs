globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, createError, getQuery as getQuery$1, getResponseStatusText } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/@prisma/client/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/ronaldo/EPITECH/JobBoardPOC/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/ronaldo/EPITECH/JobBoardPOC/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ronaldo/EPITECH/JobBoardPOC","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ronaldo/EPITECH/JobBoardPOC/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ronaldo/EPITECH/JobBoardPOC/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ronaldo/EPITECH/JobBoardPOC/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/ronaldo/EPITECH/JobBoardPOC/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_IBRy4A = () => Promise.resolve().then(function () { return person_post$1; });
const _lazy_ObI6H3 = () => Promise.resolve().then(function () { return prismaClient$1; });
const _lazy_AijIoG = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/people/person', handler: _lazy_IBRy4A, lazy: true, middleware: false, method: "post" },
  { route: '/api/prismaClient', handler: _lazy_ObI6H3, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_AijIoG, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_AijIoG, lazy: true, middleware: false, method: undefined }
];
...
const prismaClient$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  prismaClient: prismaClient
});

const person_post = defineEventHandler(async (event) => {
...
const getClientManifest = () => import('file:///home/ronaldo/EPITECH/JobBoardPOC/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/ronaldo/EPITECH/JobBoardPOC/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
